...
# 因为发件人需要登录的客户端授权码
# 第三方登录不能直接用密码, 必须用授权码
    mime['From'] = '1404536614@qq.com'
    # 收件人写自己的邮箱
    to = 'caotianyuan@menamobile.net'
    mime['To'] = to
...
# 3.登录126邮箱
    smtp.login('1404536614@qq.com', 'aaypceydeyhdgabi')
# 4.发送邮件
#     smtp.send_message(mime, from_addr='bwftest126@126.com', to_addrs=to)
    smtp.sendmail(from_addr='1404536614@qq.com', to_addrs=to, msg=mime.as_string())
# 5.退出
    smtp.quit()
    print("邮件已发送")
...
if __name__ == '__main__':
    ...
    # 6. 创建测试文件
    file = open('./report/test_report.html', 'wb')
