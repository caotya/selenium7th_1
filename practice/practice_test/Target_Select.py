...
Select(Select_1).select_by_visible_text("山西省")

Select_2 = driver.find_elements_by_class_name("add-new-area-select")[1]
Select(Select_2).select_by_visible_text("运城市")

Select_3 = driver.find_elements_by_class_name("add-new-area-select")[2]
Select(Select_3).select_by_visible_text("新绛县")